...
const ReviewsList = ({ allReviews }) => {
    ...
    const reviewsToShow = showAll ? allReviews : allReviews.slice(0, reviewsMaxLength); // show first 3 initially

    const toggleShow = () => setShowAll(!showAll);


    return (
        <div className="max-w-[1500px] w-full px-4 py-8  rounded-lg">
