...
import AnnouncementCountdownBar from '../UI/DiscountCountdownBar';
...
const TemplateHeader = ({ sectionData }) => {
  ...
  const { discountBar } = announcements ? announcements : {};
  ...
  return (
    <>
      {discountBar && discountBar?.isActive && <AnnouncementCountdownBar announcement={discountBar} />}
