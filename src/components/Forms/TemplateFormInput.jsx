    ...
    <div className="relative w-full mt-[5px]">
      ...
      <div className="relative w-full">
        ...
        <input
          ...
          className={`Inputs  placeholder:text-sm   placeholder:text-[#b9b9b9] shadow-[inset_0_0px_6px_0_rgb(0_0_0_/_0.02)] px-3 text-[var(--tmp-txt)] bg-[var(--tmp-pri)]  flex items-center border-[1.3px] w-full rounded-[4px] ${inputSizeClass} ${error ? "border-red-500" : "border-gray-300"
        ...
        {layout === "floating" && (
          <label
            className={`absolute left-3 px-1 ${labelClassname} transition-all text-[#b9b9b9] ${value || value === 0 ? "top-[-10px] text-xs" : `${size === "large" ? "top-[12px] text-base" : "top-[8px] text-sm"}`} pointer-events-none`}
          >
            {placeholder}
            {required && <span className="text-red-500"> *</span>}
          </label>
