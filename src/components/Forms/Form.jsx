...
const Form = ({
    ...
    return (
        <div className={`bg-backgroundC px-6 py-8 rounded-lg shadow-lg w-full ${className}`}>
            <h2 className="text-3xl font-bold mb-4 text-textC text-center">{lable}</h2>
            <form onSubmit={handleSubmit} className="space-y-4" encType={encType}>
                <div className='space-y-4 p-[8px] bg-backgroundC max-h-[340px] bordr-t border-[#c9c9c98f] overflow-auto customScroll'>
                {children}
                </div>
