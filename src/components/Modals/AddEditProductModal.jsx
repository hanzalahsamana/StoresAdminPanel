    ...
    <div className="relative flex flex-col gap-[20px]">
      ...
      <div className="flex flex-wrap gap-5 md:gap-0">
        ...
        <div className="w-full md:w-2/5 space-y-5 md:pl-[10px]">
          ...
          <CustomCard icon={<MdMiscellaneousServices />} title="Extras" classes="break-inside-avoid flex-none !p-4 pt-3">
          ...
          <CustomCard icon={<FaSearchengin />} title="Meta Info" info={"Meta Info helps search engines understand your product better. 'Meta Title' is the short headline shown in search results, and 'Meta Description' is a short summary that encourages people to click your product. It's optional but useful for improving visibility on Google."} classes="break-inside-avoid flex-none !p-4 pt-3">
