...
const Header = () => {
  ...
  return (
    <header className={`w-full transition-all duration-300 ease-in-out top-0 z-10 ${pathname === "/" ? 'fixed' : 'sticky'} ${pathname === `/a${siteName}`&& !isScrolled && !isOpen ? 'bg-gradient-to-b from-[#000000c4] to-transparent text-white' : 'bg-white text-black shadow-md '}`}>
