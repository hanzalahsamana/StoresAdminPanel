  ...
  return (
    <div className="flex justify-center items-start flex-col md:flex-row">
      <BackgroundFrame className="gap-0">
        <ActionCard label={'Update Home Page'} actionPosition="hidden" className={'!h-[calc(100vh-92px)]'}>
                        ...
                        <Draggable key={item._id} draggableId={item._id.toString()} index={index}>
                          {(provided, snapshot) => (
                            <div
                              ...
                              className={`relative flex items-start pt-2 pb-4 border-b border-gray-300 bg-backgroundC transition-all duration-300 ${
                            ...
                            >
                              ...
                              <div className="ml-3 flex flex-col gap-1">
                                ...
                                <div className="flex gap-3">
                                  <Link href={`./design/${item._id}`} className="text-sm cursor-pointer text-primaryC flex items-center gap-1">
                                    Edit <RxExternalLink size={12} />
                                  </Link>
                                  <h2 onClick={() => handleDelete(item._id)} className="text-sm cursor-pointer text-red-500 flex items-center gap-1">
